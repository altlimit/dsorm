...
func GetMultiStructTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		if err := dsoClient.GetMulti(ctx, keys, response); err != nil {
			t.Fatal(err)
		}
		for i := int64(0); i < 2; i++ {
...
func GetMultiStructPtrTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiStructPtrNilTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiInterfaceTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiPropertyLoadSaverTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if err := dsoClient.GetMulti(ctx, keys, uncachedEntities); err != nil {
			t.Fatal(err)
		}
		...
		if err := dsoClient.GetMulti(ctx, keys, cachedEntities); err != nil {
			t.Fatal(err)
		}
		...
		ds.SetDatastoreGetMultiHook(func(ctx context.Context,
		...
		defer ds.SetDatastoreGetMultiHook(nil)

		tes := make([]testEntity, len(entities))
		if err := dsoClient.GetMulti(ctx, keys, tes); err != nil {
			t.Fatal(err)
		}
	}
}
...
func GetMultiKeyLoaderTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiNoKeysTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiInterfaceErrorTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
...
func GetArgsTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if err := dsoClient.Get(ctx, nil, &testEntity{}); err == nil {
			t.Fatal("expected error for nil key")
		}

		key := datastore.IDKey("GetArgsTest", 1, nil)
		if err := dsoClient.Get(ctx, key, nil); err != datastore.ErrInvalidEntityType {
			t.Fatal("expected ErrInvalidEntityType for nil value")
		}

		if err := dsoClient.Get(ctx, key, datastore.PropertyList{}); err == nil {
		...
		if err := dsoClient.Get(ctx, key, rte); err == nil {
			t.Fatal("expected error for interface")
		}
	}
}

func GetMultiArgsTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		val := testEntity{}
		if err := dsoClient.GetMulti(ctx, keys, nil); err == nil {
			t.Fatal("expected error for nil vals")
		}
		structVals := []testEntity{val}
		if err := dsoClient.GetMulti(ctx, nil, structVals); err == nil {
			t.Fatal("expected error for nil keys")
		}

		if err := dsoClient.GetMulti(ctx, keys, []testEntity{}); err == nil {
			t.Fatal("expected error for unequal keys and vals")
		}

		if err := dsoClient.GetMulti(ctx, keys, datastore.PropertyList{}); err == nil {
			t.Fatal("expected error for propertyList")
		}

		rte := newReaderTestEntity()
		if err := dsoClient.GetMulti(ctx, keys, []io.Reader{rte}); err == nil {
			t.Fatal("expected error for interface")
		}
	}
}

func GetSlicePropertyTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		// Get from datastore.
		newVal := &testEntity{}
		if err := dsoClient.Get(ctx, key, newVal); err != nil {
			t.Fatal(err)
		}
...
func GetMultiNoPropertyListTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if err := dsoClient.GetMulti(ctx, keys, pl); err == nil {
			t.Fatal("expecting no PropertyList error")
		}
	}
}

func GetMultiNonStructTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if err := dsoClient.GetMulti(ctx, keys, vals); err == nil {
			t.Fatal("expecting unsupported vals type")
		}
	}
}

func GetMultiLockReturnEntitySetValueFailTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
		...
		cacheGetChan <- func(ctx context.Context,
			...
			value, err := ds.MarshalPropertyList(pl)
			if err != nil {
				return nil, err
			}

			items[keys[0]].Flags = ds.EntityItem
			items[keys[0]].Value = value
			items[keys[1]].Flags = ds.EntityItem
			items[keys[1]].Value = value
			return items, nil
		}
		close(cacheGetChan)

		testCache.getMultiHook = func(ctx context.Context,
			keys []string) (map[string]*ds.Item, error) {
			f := <-cacheGetChan
			return f(ctx, keys)
		}
...
func GetMultiLockReturnEntityTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
...
func GetMultiLockReturnUnknownTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
...
func GetMultiLockReturnMissTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
...
func GetMultiLockDatastoreUnknownErrorTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
		...
		invalidCacheKey := ds.CreateCacheKey(invalidKey)
		testCache.compareAndSwapHook = func(ctx context.Context,
			items []*ds.Item) error {
...
func GetNamespacedKeyTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if namespacedKey, err = dsoClient.Put(ctx, namespacedKey, entity); err != nil {
			t.Fatal(err)
		}

		// Prime cache.
		if err := dsoClient.Get(ctx, namespacedKey, &testEntity{}); err != nil {
			t.Fatal(err)
		}
		...
		ds.SetDatastoreGetMultiHook(nil)

		if !entityFromCache {
			t.Fatal("entity not obtained from cache")
		}

		if err := dsoClient.Delete(ctx, namespacedKey); err != nil {
			t.Fatal(err)
		}

		entity = &testEntity{}
		if err := dsoClient.Get(ctx, namespacedKey, entity); err == nil {
...
func GetMultiPathsTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
		...
		*/
		...
		tests := []struct {
		...
		}{
			{
				...
				nil,
				ds.MarshalPropertyList,
				[]unmarshalFunc{
					ds.UnmarshalPropertyList,
					ds.UnmarshalPropertyList,
				},
				[]error{nil},
				nil,
		...
		for _, test := range tests {
			t.Run(test.description, func(t *testing.T) {
				dsoClient, err := NewClient(ctx, testCache, t, test.logTester)
				if err != nil {
					t.Fatal(err)
				}

				keys, putVals := keysVals(ctx, test.keyCount)
				if _, err := dsoClient.PutMulti(ctx, keys, putVals); err != nil {
					t.Fatal(err)
				}
				...
				testCache.getMultiHook = func(ctx context.Context, keys []string) (
					map[string]*ds.Item, error) {
					fn := <-cacheGetChan
					return fn(ctx, keys)
				}

				testCache.addMultiHook = test.cacheAddMulti
				testCache.compareAndSwapHook = test.cacheCompareAndSwapMulti

				ds.SetDatastoreGetMultiHook(test.datastoreGetMulti)

				ds.SetMarshal(test.marshal)
				...
				ds.SetUnmarshal(func(data []byte, pl *datastore.PropertyList) error {
					fn := <-unmarshalChan
					return fn(data, pl)
				})
				...
				for i := 0; i < test.callCount; i++ {
					...
					err := dsoClient.GetMulti(ctx, keys, getVals)
				...
				testCache.getMultiHook = nil
				testCache.addMultiHook = nil
				testCache.compareAndSwapHook = nil
				ds.SetDatastoreGetMultiHook(nil)
				ds.SetMarshal(ds.MarshalPropertyList)
				ds.SetUnmarshal(ds.UnmarshalPropertyList)
...
func PropertyLoadSaverTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		keys, err = dsoClient.PutMulti(ctx, keys, entities)
		if err != nil {
			t.Fatal(err)
		}

		entities = make([]*loadSaveStruct, 1)
		if err := dsoClient.GetMulti(ctx, keys[:1], entities); err != nil {
			t.Fatal(err)
		}
...
func KeyLoaderTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func UnsupportedValueTypeTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func GetMultiFieldMismatchTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		// Get from datastore using ds.
		dsoResponse := make([]testEntityLean, len(keys))
		dsoErr := dsoClient.GetMulti(ctx, keys, dsoResponse)

		// Get from datastore using google api
		dsResponse := make([]testEntityLean, len(keys))
		dsErr := dsClient.GetMulti(ctx, keys, dsResponse)

		if dsoErr.Error() != dsErr.Error() {
			t.Fatal("Errors are not equal")
		}

		for i := int64(0); i < 2; i++ {
			if dsoResponse[i].IntVal != dsResponse[i].IntVal {
				t.Fatalf("IntVals are not equal %d %d", dsoResponse[i].IntVal, dsResponse[i].IntVal)
			}
		}
	}
}

func GetMultiExpiredContextTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		if _, err := dsoClient.Put(ctx, keys[0], &testEntity{1}); err != nil {
			t.Fatalf("got err %v", err)
		}

		entities := make([]testEntity, 1)
		if err := dsoClient.GetMulti(cctx, keys, entities); err == nil {
...
// but dso is unaware
func PropertyLoadSaverModificationTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
