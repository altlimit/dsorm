...
func TransactionGetTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		wasCalled := false
		testCache := &mockCache{
			cacher: cacher,
			getMultiHook: func(_ context.Context, _ []string) (map[string]*ds.Item, error) {
				wasCalled = true
...
func RunInTransactionErrorTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		wasCalled := false
		testCache := &mockCache{
			cacher: cacher,
...
func TransactionTrackingTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
		...
		for i, key := range testKeys {
			...
			if _, err = dsoClient.Put(ctx, key, &testEntity{i}); err != nil {
		...
		_, err = dsoClient.RunInTransaction(ctx, func(tx *ds.Transaction) error {
			...
			mutations := []*ds.Mutation{
				ds.NewInsert(testKeys[4], &newEntity),
				ds.NewUpsert(testKeys[5], &newEntity),
				ds.NewUpdate(testKeys[6], &newEntity),
				ds.NewDelete(testKeys[7]),
			}
		...
		// Cleanup
		_ = dsoClient.DeleteMulti(ctx, testKeys)
	}
}

func TransactionNewErrorTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		...
		_, terr := dsoClient.NewTransaction(badctx)
		if terr == nil {
...
func TransactionCommitTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		txn, terr := dsoClient.NewTransaction(ctx)
		if terr != nil {
		...
		var dest testEntity
		if err = dsoClient.Get(ctx, key, &dest); err != nil {
...
func TransactionCommitErrorTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		testCache := &mockCache{
			cacher: cacher,
		}
...
func TransactionRollbackTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func TransactionOptionsTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
...
func ClearNamespacedLocksTest(ctx context.Context, cacher ds.Cache) func(t *testing.T) {
	return func(t *testing.T) {
		dsoClient, err := NewClient(ctx, cacher, t, nil)
		if err != nil {
			t.Fatal(err)
		...
		entity := &testEntity{}
		if err := dsoClient.Get(ctx, key, entity); err != nil {
			t.Fatal(err)
		}
